...
double auxconstraint::percival_wmap9_chisq(const gsl_vector *v, void *params) {
  ...
  double delta_params_wmap[3]; //Between params and WMAP fits
  delta_params_wmap[0] = la - wmap9_params[0];
  delta_params_wmap[1] = R - wmap9_params[1];
  delta_params_wmap[2] = zstar - wmap9_params[2];
...
////////////////////////////////////////////////////////////////////
//               Percival (09) + WMAP9 BAO constraints
////////////////////////////////////////////////////////////////////

const gsl_multimin_fminimizer_type* auxconstraint::baoP09_wmap9yr_dls::T =
  gsl_multimin_fminimizer_nmsimplex;

auxconstraint::baoP09_wmap9yr_dls::baoP09_wmap9yr_dls(bool fcurv, double ok) :
  base_auxconstraint(fcurv,ok) {
  v = gsl_vector_alloc(2);
  ss = gsl_vector_alloc(2);
  const gsl_multimin_fminimizer_type *T = gsl_multimin_fminimizer_nmsimplex;
...
auxconstraint::baoP09_wmap9yr_dls::~baoP09_wmap9yr_dls() {
  gsl_vector_free(v);
  gsl_vector_free(ss);
  gsl_multimin_fminimizer_free(s);
}
...
/*!
  ...
  \param[in] om  \f$\Omega_m\f$
  \param[in] ode \f$\Omega_{DE}\f$
  \returns \f$\chi^2\f$ at parameter values for Percival BAO + WMAP9 parameters
...
*/
double
auxconstraint::baoP09_wmap9yr_dls::GetChiSq(double w0, double wa,
					    double om, double ode) {
  ...
  //Setup function
  minex_func.n = 2;
  minex_func.f = &percival_wmap9_chisq;
  minex_func.params = vptr;
  ...
  //Get chisq at minimum
  double chisq;
  chisq = percival_wmap9_chisq( s->x, varr );
